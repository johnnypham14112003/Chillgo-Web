...
//Style CSS
import "../../styles/buttons/Buttion_Arrow_R_3d.css";
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        height="208"
        width="342"
        className="button-arrow-splash-effect"
      >
        <path
      ...
      <div className="button-arrow-text-background">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 221 42"
          height="42"
          width="221"
          className="rotate-arrow-line-path"
        >
          <path
            stroke-linecap="round"
            stroke-width="3"
        ...
        <div className="button-border-outline"></div>
        <div className="content-container">
          <span className="content-text state-1">
            <span data-label={textDisplay} style={{ "--c": "1" } as CSSProperties}>
              {textDisplay}
            </span>
          </span>
          ...
          <span className="content-text state-2">
            <span data-label={textClickedDisplay} style={{ "--c": "1" } as CSSProperties}>
              {textClickedDisplay}
            </span>
          </span>
        </div>
