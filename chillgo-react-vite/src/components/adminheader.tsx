...
import logo from "../assets/images/logo/logo-light-theme.png";
import { useNavigate } from "react-router-dom";
// Import your custom hook or replace with your data fetching logic
  ...
  return (
    <header className="absolute top-0 w-full z-10 bg-white pb-2">
      <div className="flex flex-col items-center justify-center gap-2">
        {/* Top Bar */}
        <div className="top-bar w-full h-[37px] flex flex-row items-center justify-between py-2 text-white bg-[#0055C3]">
